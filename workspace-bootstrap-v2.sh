...
# ============================================================
echo "[10/10] Configuring fish, starship, lazygit, and git..."
...
echo ""
echo "Persistent (survive rebuild): starship, lazygit, eza, zoxide, fzf, harlequin,"
echo "                              LazyVim config, fish config, starship config,"
echo "                              lazygit config, git aliases, fish aliases"
echo ""
